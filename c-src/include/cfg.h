...
#define CFG_PROFILE_FREQSLOPECONST 932U * 8
...
// Anything with _NF_ or NF_ pertains to a new frame format
// RD = Range/Doppler
#define CFG_USE_NF_FMT 1 
#define CFG_NF_NUMADCSAMPLES 512 
#define NUM_NF_RD_CHIRPS 128
#define NUM_NF_ANGLECHIRPS 16
#define NF_RD_CHIRP_DATASIZE (CFG_NF_NUMADCSAMPLES * SAMPLE_SIZE) // We're only using 1Tx/1Rx 
#define NF_ANGLE_CHIRP_DATASIZE (CFG_NF_nUMADCSAMPLES * NUM_RX_ANTENNAS * SAMPLE_SIZE)
